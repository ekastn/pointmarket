...
func main() {
	...
	assignmentService := services.NewAssignmentService(querier, pointsService, studentService)
	quizService := services.NewQuizService(querier, pointsService, studentService)
