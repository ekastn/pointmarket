...
class NLPAnalyzer {
    constructor() {
        this.apiUrl = '/api/nlp/analyze'; // Updated API URL
     ...
     */
    getJwtToken() {
        // In a real application, you would get this from a secure place.
        // For this example, we'll assume it's stored in session storage.
        ...
        try {
            const response = await fetch(this.apiUrl, {
                ...
                headers: {
                    ...
                    'Authorization': `Bearer ${this.getJwtToken()}` // Add JWT token
                },
                body: JSON.stringify({
                    text: text,
                    context_type: this.getContext(textarea),
