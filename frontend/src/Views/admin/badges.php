...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-12 col-md-6">
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTambahBadge">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                echo $renderer->includePartial('components/partials/tabel_badges', [
                    'badges' => $badges,
                    'page' => $page,
                    'limit' => $limit,
