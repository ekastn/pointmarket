...
<div class="container-fluid">
  ...
  <?php elseif (!empty($messages['error'])): ?>
    <div class="alert alert-danger">
      <?= htmlspecialchars(is_array($messages['error']) ? json_encode($messages['error']) : $messages['error']) ?>
    </div>
  <?php endif; ?>
    ...
    <div class="col-12">
      <div class="card shadow-sm">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <a href="/admin/recommendations/items/export" target="_blank" class="btn btn-outline-success btn-sm"><i
        ...
        <div class="card-body">
          <form method="get" class="row g-2 align-items-end">
            <div class="col-md-3">
              ...
              <input type="text" name="state_like" class="form-control"
                value="<?= htmlspecialchars($filters['state_like'] ?? '') ?>" placeholder="contains..." />
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
              ...
              <input type="number" name="ref_id" class="form-control"
                value="<?= htmlspecialchars($filters['ref_id'] ?? '') ?>" />
            </div>
            <div class="col-md-2">
          ...
          <form method="post" action="/admin/recommendations/items" id="create-item-form">
            <div class="row g-2 align-items-end">
              <div class="col-md-4 position-relative">
                ...
                <div id="states-menu" class="list-group position-absolute w-100 border bg-white"
              ...
              <div class="col-md-2 position-relative">
                ...
                <input type="text" class="form-control" id="ref-search" autocomplete="off"
                  placeholder="type to search..." />
                <div id="refs-menu" class="list-group position-absolute w-100 border bg-white"
                  style="z-index:1000; display:none; max-height:240px; overflow:auto;"></div>
  ...
  <div class="row pm-section">
    ...
    $columns = [
      ...
      [
        ...
        'formatter' => function ($v) {
          return $v !== null ? number_format($v, 3) : '<span class="text-muted">-</span>';
        }
      ],
      [
        'label' => 'Ref',
      ...
      [
        ...
        'key' => 'is_active',
        'formatter' => function ($v) {
          return !empty($v) ? '<span class="badge bg-success">Active</span>' : '<span class="badge bg-secondary">Inactive</span>';
        }
      ],
    ];
    ...
    $actions = [
      ...
      [
        'label' => 'Edit',
        'icon' => 'fas fa-edit',
        'class' => 'btn-outline-primary js-edit-item',
