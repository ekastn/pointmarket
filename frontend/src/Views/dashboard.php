...
// $user, $studentStats, $questionnaireScores, $counts, $messages

// Ensure variables are defined to prevent PHP notices if not passed
$user = $user ?? ['name' => 'Guest', 'role' => 'guest'];
$studentStats = $studentStats ?? ['total_points' => 0, 'completed_assignments' => 0];
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <?php elseif ($user['role'] === 'guru'): ?>
                                        <div class="col-md-3 mb-2">
                                            <a href="/assignments?action=create" class="btn btn-primary w-100">
                                                <i class="fas fa-plus me-2"></i>
                                                Create Assignment
                                            </a>
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            <a href="/quiz?action=create" class="btn btn-success w-100">
                                                <i class="fas fa-plus me-2"></i>
                                                Create Quiz
                                            </a>
                                        </div>
                                        <div class="col-md-3 mb-2">
                                            <a href="/materials?action=create" class="btn btn-info w-100">
