                ...
                <div class="card-body text-center">
                    <?php if (isset($questionnaireStats['mslq']) && $questionnaireStats['mslq']['total_completed'] > 0): ?>
                        ...
                        <div class="progress progress-custom mb-2">
                            <div class="progress-bar bg-success" style="width: <?php echo htmlspecialchars(($questionnaireStats['mslq']['average_score'] / 5) * 100); ?>%"></div>
                        </div>
            ...
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body text-center">
                    <?php if (isset($questionnaireStats['ams']) && $questionnaireStats['ams']['total_completed'] > 0): ?>
                        ...
                        <div class="progress progress-custom mb-2">
                            <div class="progress-bar bg-warning" style="width: <?php echo htmlspecialchars(($questionnaireStats['ams']['average_score'] / 5) * 100); ?>%"></div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-md-3 mb-3">
                            <a href="/dashboard" class="btn btn-outline-primary d-block">
                                <i class="fas fa-tachometer-alt fa-2x mb-2"></i><br>
                                Dashboard
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="/questionnaire" class="btn btn-outline-success d-block">
                                <i class="fas fa-clipboard-list fa-2x mb-2"></i><br>
                                Assessments
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="/weekly-evaluations" class="btn btn-outline-warning d-block">
                                <i class="fas fa-calendar-check fa-2x mb-2"></i><br>
                                Weekly Evaluations
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="/vark-assessment" class="btn btn-outline-info d-block">
