    ...
    <div class="container">
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <a href="panduan-nlp-demo-simplified.html" class="btn btn-light btn-sm" target="_blank">
            ...
            <div class="card-body">
                <p class="alert alert-info">
                    ...
                    <br><small class="text-muted mt-1 d-block">
                        ...
                        Untuk panduan lengkap, lihat <a href="panduan-nlp-demo-simplified.html" target="_blank">Panduan Penggunaan</a>
                    </small>
                </p>
        ...
        <div class="text-center mb-4">
            <a href="navigation.html" class="btn btn-sm btn-outline-secondary">
